  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-navy flex flex-col z-30">
        {/* Logo */}
<div className="flex items-center gap-3 px-5 py-4 border-b border-white/10 min-h-16">
  <img
    src={SthGoldLogo}
  ...
  <div className="min-w-0">
    ...
    <p className="text-gold text-xs font-semibold tracking-widest uppercase whitespace-nowrap">
      Housing
    </p>
  </div>
</div>
              ...
              <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-lg z-50 max-h-72 overflow-y-auto">
                {allHits.length === 0 ? (
                  ...
                  allHits.map((hit) => (
                    ...
                    >
                      <span className="text-gold text-xs font-medium uppercase mr-2">
                        {hit.type}
                      </span>
